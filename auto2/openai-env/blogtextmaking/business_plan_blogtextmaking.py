...
system_message_role = {
    "role": "system",
    "content": "이 대화는 브랜드 및 사업 계획 수립에 관한 전문가의 관점으로 진행됩니다. 전략 수립안 작성, 신규사업 계획 수립, 시장 분석 및 전략 개발 등에 대한 심도 있는 조언과 구체적인 사례를 포함하여 해결 방안을 제시합니다. 전문가는 사업 계획서 작성법, 신제품/기술 컨셉 개발, 마케팅 전략, 운영계획, 수익 및 재무계획, 시장 세분화 및 타겟팅, 포지셔닝 전략 등을 포함한 전략적 사업 계획 수립의 모든 측면을 다룹니다. 또한, 문제 진단, 목표 시장 선정, 실행 방안의 평가, 그리고 해외 시장 조사 분석 방법론을 포함하여, 브랜드 및 제품 개발에 필요한 포괄적인 지식을 제공합니다."
}
...
for content_item in content_items:
    ...
    system_message_first = {
        "role": "system", 
        "content": f"({content_item}) 내용을 분석하여 아래 메뉴얼 대해 논의하고, 사업 계획서 작성법, 신제품/기술 컨셉 개발, 마케팅 전략, 운영계획, 수익 및 재무계획, 시장 세분화 및 타겟팅, 포지셔닝 전략 등을 포함한 전략적 사업 계획 수립을 포함하여, 자금 조달의 구체적인 예시와 실제 적용 사례를 포함하여 해결 방안을 제시합니다."
    }
...
#     # Five_completion3 호출
#     Five_completion3 = client.chat.completions.create(
#         model="gpt-4-1106-preview",
#         messages=[{
#             "role": "system", 
#             "content": f"""
...
#     messages.append({
#         "role": "assistant",
#         "content": Five_completion3.choices[0].message.content
#     })
...
#     })
    ...
    #     Five_completion3.choices[0].message.content+\
    #     six_completion.choices[0].message.content

    print(total_response_text)

    # 이미지 생성을 위한 프롬프트 정의
    prompt = f"블로그에 쓰일 내용인데 ({content_item})를 분석하여 사업 계획서 작성법, 신제품/기술 컨셉 개발, 마케팅 전략, 운영계획, 수익 및 재무계획, 시장 세분화 및 타겟팅, 포지셔닝 전략 등을 포함한 전략적 사업 계획 수립 내용과 연관하여 전문적이고 현대적인 스타일의 이미지를 생성해주세요. 상세하고 현실적인 표현을 원합니다."
    # DALL-E를 사용하여 이미지 생성
    ...
    blogtag_response = client.chat.completions.create(
        model="gpt-4-1106-preview",
        messages=[{"role": "system", "content": f"블로그에 쓰일 내용인데 ({content_item})를 분석하여 사업 계획서 작성법, 신제품/기술 컨셉 개발, 마케팅 전략, 운영계획, 수익 및 재무계획, 시장 세분화 및 타겟팅, 포지셔닝 전략 등을 포함한 전략적 사업 계획 수립 같은 주제를 다루고 있습니다. 이와 관련하여 독자들의 관심을 끌 수 있는, 검색 최적화에 유용한 키워드 태그 5개를 제안해주세요. 숫자와 설명, '#'은 제외하고, 각 태그를 쉼표(,)로 구분하여 한글로 작성해주세요."}]
    )
